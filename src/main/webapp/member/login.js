document.addEventListener('DOMContentLoaded', function() {
	...
	uResButton.addEventListener('click', function() {
		window.location.href = '/community/registerForm.do';
	});
	...
	uLoginButton.addEventListener('click', function() {
		...
		xhr.open('POST', '/community/loginPro.do', true);
...
function uUpdate() {
	alert("회원 정보 변경");
	window.location.href = '/community/modify.do';
}

// [로그아웃] 버튼 클릭 
function uLogout() {
	fetch('/community/logout.do', {
		method: 'POST'
